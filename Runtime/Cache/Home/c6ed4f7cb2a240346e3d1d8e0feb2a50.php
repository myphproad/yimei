        ...
        <form action="<?php echo U('config');?>" class="form-horizontal" method="post">
            <?php if(empty($custom_config)): ?><div class="field_group">
                        ...
                        <div class="card_preview fl" style="margin:15px 40px;">
                        	<div id="cardLogo" style="display:none"><img src="/Yimei/Public/Home/images/default.png"></div>
...
<link type="text/css" rel="stylesheet" href="/Yimei/Public/static/colorpicker/colpick.css?v=<?php echo SITE_VERSION;?>"/>
<script type="text/javascript" src="/Yimei/Public/static/colorpicker/colpick.js?v=<?php echo SITE_VERSION;?>" charset="UTF-8"></script> 
