...
<head>
    ...
    <link href="/eciyuanWebsite/Yimei/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/eciyuanWebsite/Yimei/Public/Admin/css/base.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/eciyuanWebsite/Yimei/Public/Admin/css/common.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/eciyuanWebsite/Yimei/Public/Admin/css/module.css?v=<?php echo SITE_VERSION;?>" />
    <link rel="stylesheet" type="text/css" href="/eciyuanWebsite/Yimei/Public/Admin/css/style.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/eciyuanWebsite/Yimei/Public/Admin/css/store.css?v=<?php echo SITE_VERSION;?>" media="all">
	<link rel="stylesheet" type="text/css" href="/eciyuanWebsite/Yimei/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css?v=<?php echo SITE_VERSION;?>" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/eciyuanWebsite/Yimei/Public/Admin/js/jquery.mousewheel.js?v=<?php echo SITE_VERSION;?>"></script>
    <!--<![endif]-->
...
<!--            <td><?php echo ($vo["admin_public_count"]); ?></td>
	...
	var  IMG_PATH = "/eciyuanWebsite/Yimei/Public/Admin/images";
    ...
    <script type="text/javascript" src="/eciyuanWebsite/Yimei/Public/static/think.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript" src="/eciyuanWebsite/Yimei/Public/Admin/js/common.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript">
        +function(){
	...
	<script src="/eciyuanWebsite/Yimei/Public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION;?>"></script>
